...
![Default](https://img.shields.io/badge/Default-{{ if (has $input "default") }}{{ tmpl.Exec "sanitize_url" $input.default }}{{ else }}none{{ end }}-{{ if (has $input "default") }}{{ crypto.Bcrypt $input.default }}{{ else }}inactive{{ end }}?style=flat-square)
